...
//!
//! Matrices are supplied in CSR (3-array) form with 1-based indexing (PARDISO's
//! default). [`Pardiso::solve`] runs the analysis → factorization → solve
//! phases and returns the solution.
